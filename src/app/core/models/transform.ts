...
export namespace Convert {
  ...
  const typeMap: any = {
      "Welcome": o([
          ...
          { json: "properties", js: "properties", typ: r("WelcomeProperties") },
          { json: "required", js: "required", typ: a("") },
      ], false),
      "Definitions": o([
          { json: "org_information_def", js: "orgInformationDef", typ: r("OrgInformationDef") },
          { json: "signing_authority_information_def", js: "signingAuthorityInformationDef", typ: r("SigningAuthorityInformationDef") },
          { json: "access_administrator_present_def", js: "accessAdministratorPresentDef", typ: r("AccessAdministratorPresentDef") },
          { json: "user_def", js: "userDef", typ: r("UserDef") },
          { json: "msp_group_def", js: "mspGroupDef", typ: r("MspGroupDef") },
      ], false),
      "AccessAdministratorPresentDef": o([
          { json: "type", js: "type", typ: "" },
          { json: "properties", js: "properties", typ: r("AccessAdministratorPresentDefProperties") },
          { json: "required", js: "required", typ: a("") },
      ], false),
      "AccessAdministratorPresentDefProperties": o([
          { json: "aa_curtesy_title", js: "aaCurtesyTitle", typ: r("PuneHedgehog") },
          { json: "aa_last_name", js: "aaLastName", typ: r("PuneHedgehog") },
          { json: "aa_first_name", js: "aaFirstName", typ: r("PuneHedgehog") },
          { json: "aa_initial", js: "aaInitial", typ: r("PuneHedgehog") },
          { json: "aa_job_title", js: "aaJobTitle", typ: r("PuneHedgehog") },
          { json: "aa_email", js: "aaEmail", typ: r("PuneHedgehog") },
          { json: "aa_phone_num", js: "aaPhoneNum", typ: r("AaFaxNum") },
          { json: "aa_phone_ext", js: "aaPhoneEXT", typ: r("PuneHedgehog") },
          { json: "aa_fax_num", js: "aaFaxNum", typ: r("AaFaxNum") },
          { json: "aa_msp_access", js: "aaMspAccess", typ: r("AaFaxNum") },
      ...
      "MspGroupDef": o([
          { json: "type", js: "type", typ: "" },
          { json: "properties", js: "properties", typ: r("MspGroupDefProperties") },
          { json: "required", js: "required", typ: a("") },
      ], false),
      "MspGroupDefProperties": o([
          { json: "mspgroup_num", js: "mspgroupNum", typ: r("PuneHedgehog") },
          { json: "third_party", js: "thirdParty", typ: r("AaFaxNum") },
      ], false),
      "OrgInformationDef": o([
          { json: "type", js: "type", typ: "" },
          { json: "properties", js: "properties", typ: r("OrgInformationDefProperties") },
          { json: "required", js: "required", typ: a("") },
      ], false),
      "OrgInformationDefProperties": o([
          ...
          { json: "street_name", js: "streetName", typ: r("PuneHedgehog") },
          ...
          { json: "contracting_out", js: "contractingOut", typ: r("ContractingOut") },
          { json: "blue_cross", js: "blueCross", typ: r("AaFaxNum") },
          { json: "org_spg", js: "orgSpg", typ: r("AaFaxNum") },
      ], false),
      "ContractingOut": o([
          { json: "type", js: "type", typ: "" },
          { json: "properties", js: "properties", typ: r("ContractingOutProperties") },
          { json: "required", js: "required", typ: a("") },
      ], false),
      "ContractingOutProperties": o([
          { json: "contracting_third_party", js: "contractingThirdParty", typ: r("AaFaxNum") },
          { json: "third_party_org_num", js: "thirdPartyOrgNum", typ: r("PuneHedgehog") },
      ], false),
      "SigningAuthorityInformationDef": o([
          { json: "type", js: "type", typ: "" },
          { json: "properties", js: "properties", typ: r("SigningAuthorityInformationDefProperties") },
          { json: "required", js: "required", typ: a("") },
      ], false),
      "SigningAuthorityInformationDefProperties": o([
          { json: "sa_curtesy_title", js: "saCurtesyTitle", typ: r("PuneHedgehog") },
          { json: "sa_last_name", js: "saLastName", typ: r("PuneHedgehog") },
          { json: "sa_first_name", js: "saFirstName", typ: r("PuneHedgehog") },
          { json: "sa_initial", js: "saInitial", typ: r("PuneHedgehog") },
          { json: "sa_job_title", js: "saJobTitle", typ: r("PuneHedgehog") },
          { json: "sa_email", js: "saEmail", typ: r("PuneHedgehog") },
          { json: "sa_phone_num", js: "saPhoneNum", typ: r("AaFaxNum") },
          { json: "sa_phone_ext", js: "saPhoneEXT", typ: r("PuneHedgehog") },
          { json: "sa_fax_num", js: "saFaxNum", typ: r("AaFaxNum") },
          { json: "sa_msp_access", js: "saMspAccess", typ: r("AaFaxNum") },
          { json: "sa_spg", js: "saSpg", typ: r("AaFaxNum") },
          { json: "sa_ldap_id", js: "saLDAPID", typ: r("AaFaxNum") },
      ], false),
      "UserDef": o([
          { json: "type", js: "type", typ: "" },
          { json: "properties", js: "properties", typ: r("UserDefProperties") },
          { json: "required", js: "required", typ: a("") },
      ], false),
      "UserDefProperties": o([
          { json: "user_curtesy_title", js: "userCurtesyTitle", typ: r("PuneHedgehog") },
          { json: "user_last_name", js: "userLastName", typ: r("PuneHedgehog") },
          { json: "user_first_name", js: "userFirstName", typ: r("PuneHedgehog") },
          { json: "user_initial", js: "userInitial", typ: r("PuneHedgehog") },
          { json: "user_job_title", js: "userJobTitle", typ: r("PuneHedgehog") },
          { json: "user_email", js: "userEmail", typ: r("PuneHedgehog") },
          { json: "user_phone_num", js: "userPhoneNum", typ: r("AaFaxNum") },
          { json: "user_phone_ext", js: "userPhoneEXT", typ: r("PuneHedgehog") },
          { json: "user_fax_num", js: "userFaxNum", typ: r("AaFaxNum") },
          { json: "user_spg", js: "userSpg", typ: r("AaFaxNum") },
      ], false),
      "WelcomeProperties": o([
          { json: "org_information", js: "orgInformation", typ: r("Items") },
          { json: "signing_authority_information", js: "signingAuthorityInformation", typ: r("Items") },
          { json: "access_administrator_present", js: "accessAdministratorPresent", typ: r("AccessAdministratorPresent") },
          { json: "users", js: "users", typ: r("AccessAdministratorPresent") },
          { json: "type", js: "type", typ: "" },
