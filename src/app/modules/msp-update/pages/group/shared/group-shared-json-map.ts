...
export function getAddJsonOfMspGroup(formValues) {
    ...
    let json: any = {};
    json.mspgroup_num =
        formValues && formValues.groupNo ? formValues.groupNo : '';
    if (jsonMaps.isValidOptionalField(formValues.thirdPartyAdmin)) {
        json.third_party = formValues.thirdPartyAdmin;
    }
...
export function getAddJSONofMspGroup(formValue) {
    ...
    formValuesArray.forEach((formValues) => {
        const json: jsonInterfaces.ji_msp_group_def = {
            ...
            third_party: formValues.thirdPartyAdmin
                ? formValues.thirdPartyAdmin
                : 'N',
        };
        jsonArray.push(json);
    });
...
export function getEditJsonOfMspGroup(formValues) {
    ...
    json.mspgroup_num =
        formValues && formValues.groupNo ? formValues.groupNo : '';
    json.third_party =
        formValues && formValues.thirdPartyAdmin
            ? formValues.thirdPartyAdmin
            : '';
